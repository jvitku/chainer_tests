...
##################################### links ~ the same as function

f = L.Linear(3, 2)  # f(x)=Wx+b         3 inputs 2 outputs
f.zerograds()       # delete gradients
print "f"
print f.W.data
print f.b.data
...
y = f(x)            # apply function
y.grad = np.ones((2, 2), dtype=np.float32)  # initialize gradients
